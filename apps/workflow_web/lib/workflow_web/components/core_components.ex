defmodule WorkflowWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(WorkflowWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(WorkflowWeb.Gettext, "errors", msg, opts)
    end
  end
